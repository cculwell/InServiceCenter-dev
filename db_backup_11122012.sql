...
--
-- Table structure for table `categories_curriculums`
--

DROP TABLE IF EXISTS `categories_curriculums`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `categories_curriculums` (
  `categories_curriculum_id` int(11) NOT NULL AUTO_INCREMENT,
  `categories_curriculum` varchar(25) DEFAULT NULL,
  PRIMARY KEY (`categories_curriculum_id`)
) ENGINE=InnoDB AUTO_INCREMENT=463 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `categories_curriculums`
--

LOCK TABLES `categories_curriculums` WRITE;
/*!40000 ALTER TABLE `categories_curriculums` DISABLE KEYS */;
INSERT INTO `categories_curriculums` VALUES (1,'Biology'),(2,'Chemistry'),(3,'English/Language Art'),(4,'Technology'),(5,'Career Tech'),(6,'Counseling'),(7,'Climate and Culture'),(8,'Effective Instruction'),(9,'Fine Arts'),(10,'Foreign Language'),(11,'Gifted'),(12,'Interdisciplinary'),(13,'Leadership'),(14,'Library Media Services'),(15,'Mathematics'),(16,'NBCT'),(17,'Physics'),(18,'Physical Education'),(19,'Science'),(20,'Social Studies'),(21,'Special Education'),(22,'Other');
/*!40000 ALTER TABLE `categories_curriculums` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-11-13  2:40:34
