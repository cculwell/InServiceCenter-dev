...
$sql = "INSERT INTO tblGeneralRequest (vcSchool, vcSystem, vcRequest, vcJustification, dtDate01, dtDate02, dtTime01, dtTime02, vcLocation, iTotalHours, vcTargetPartic, iNumPartic, vcEvalMethod, vcCompany, vcContactInfo, fAmount, vcContact, vcPhone, vcEmail)
VALUES ('". 
$_GET['school'] . "', '" .
$_GET['system'] . "', '" .
$_GET['request'] . "', '" .
