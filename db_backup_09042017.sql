...
CREATE TABLE `books` (
  ...
  `eval_method` varchar(50) DEFAULT NULL,
...
CREATE TABLE `contacts` (
  ...
  `contact_emai` varchar(100) DEFAULT NULL,
...
CREATE TABLE `requests` (
  ...
  `request_justification` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2017-09-04 21:17:53
